...
def test_separate_dimensions_with_no_dimension_units_1():
    assert _utils._separate_dimensions("a couple of large apples") == [
...
def test_separate_dimensions_with_no_dimension_units_2():
    assert _utils._separate_dimensions("1 cup of flour (2 oz)") == [
        "1 cup of flour (2 oz)",
        [],
    ]
