...
def test_replace_number_followed_by_inch_symbol_type1_3():
    assert (
        _utils._replace_number_followed_by_inch_symbol('waffle round (4" dia)')
        == "waffle round (4inch dia)"
    )


def test_replace_number_followed_by_inch_symbol_type1_4():
    assert (
        _utils._replace_number_followed_by_inch_symbol("waffle round (4 inch dia)")
        == "waffle round (4 inch dia)"
    )


def test_replace_number_followed_by_inch_symbol_type1_5():
    assert (
        _utils._replace_number_followed_by_inch_symbol('waffle round (4 inch dia) 4"')
        == "waffle round (4 inch dia) 4inch"
    )


def test_replace_number_followed_by_inch_symbol_type2():
    assert (
        _utils._replace_number_followed_by_inch_symbol(
            "fruit (4-2/3” long x 2-3/4” dia)"
        )
        == "fruit (4-2/3inch long x 2-3/4inch dia)"
    )
...
def test_replace_number_followed_by_inch_symbol_type2_2():
    assert (
        _utils._replace_number_followed_by_inch_symbol(
            'fruit (4-2/3” long x 2-3/4” dia) 4"'
        )
        == "fruit (4-2/3inch long x 2-3/4inch dia) 4inch"
    )
...
def test_replace_number_followed_by_inch_symbol_decimal_decimal_range_type1_multispaced():
    assert (
        _utils._replace_number_followed_by_inch_symbol("4.5-3/4  ”") == "4.5-3/4  inch"
    )
...
def test_replace_number_followed_by_inch_symbol_decimal_decimal_range_type1_both_numbers_have_symbols():
    assert (
        _utils._replace_number_followed_by_inch_symbol("4.5”-3/4”") == "4.5inch-3/4inch"
    )


def test_replace_number_followed_by_inch_symbol_decimal_decimal_range_type1_both_numbers_have_symbols_multispaced():
    assert (
        _utils._replace_number_followed_by_inch_symbol("4.5  ”-3/4  ”")
        == "4.5  inch-3/4  inch"
    )
