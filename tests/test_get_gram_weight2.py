...
def test_get_gram_weight2_one_ounce():
    ...
    gram_weight = (
        round(float(gram_weights["gram_weight"]))
        if gram_weights["gram_weight"]
        else None
    )
    min_gram_weight = (
        round(float(gram_weights["min_gram_weight"]))
        if gram_weights["min_gram_weight"]
        else None
    )
    max_gram_weight = (
        round(float(gram_weights["max_gram_weight"]))
        if gram_weights["max_gram_weight"]
        else None
    )
...
def test_get_gram_weight2_one_tablespoon_complex_flours():
    ...
    gram_weights = _utils._get_gram_weight2(
        "whole grain wheat oat flour", "1", "tablespoon"
    )
...
def test_get_gram_weight2_invalid_unit():
    assert _utils._get_gram_weight2("olive oil", "1", "fgdhdjgfhdf") == {
        "gram_weight": None,
