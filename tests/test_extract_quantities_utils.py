...
def test_extract_quantity_unit_pairs_mixed_number_1():
    ...
    assert _utils._extract_quantity_unit_pairs("1 1/2 cups of sugar") == [
        ("1", "cups"),
        ("1/2", "cups"),
    ]
...
def test_extract_quantity_unit_pairs_decimal_then_whole_number_with_second_unit():
    assert _utils._extract_quantity_unit_pairs("1.5 cups and 2 tbs of sugar") == [
        ("1.5", "cups"),
        ("2", "tbs"),
    ]
...
def test_extract_quantity_unit_pairs_decimal_then_whole_number_with_second_unit_2():
    assert _utils._extract_quantity_unit_pairs("1.5 cups and 221 tbs of sugar") == [
        ("1.5", "cups"),
        ("221", "tbs"),
    ]
...
def test_extract_quantity_unit_pairs_decimal_then_decimal_with_second_unit_3():
    assert _utils._extract_quantity_unit_pairs("1.5 cups and 0.5 tbs of sugar") == [
        ("1.5", "cups"),
        ("0.5", "tbs"),
    ]
