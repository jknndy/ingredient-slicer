...
UNITS = {
    ...
    "whole fryer": (
        "whole fryer",
        "whole fryers",
    ),  # TODO: just added to try and get gram weights for whole versions of various meats (i.e. 'whole chicken/fryer' as a unit)
    "wing": ("wing", "wings"),
}
...
DIMENSION_UNITS = {
    ...
    "inch": (
        "inch",
        "inches",
    ),  # TODO: Removing unit "in" for now, unit "in" needs to be dealt with separately somehow, "in" is used for both the unit "inch" and the standard usage of the word "in" (i.e. "I am in a house")
...
QUANTITY_PER_UNIT_STRINGS = set(("each", "per", "apiece", "a piece", "per each"))
...
FOOD_DENSITY = {"syrup": 1.2, "water": 1.0, "fat": 0.8, "aerated": 0.5}
